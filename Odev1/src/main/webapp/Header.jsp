...
<header>
	...
	<nav>
		<ul>
			...
			<li><a href="settings.jsp" class="menu-item">Forum</a></li>
			<li><a href="about.jsp" class="menu-item">Fotoğraflar</a></li>
			<li><a href="about.jsp" class="menu-item">Videolar</a></li>
			<li><a href="about.jsp" class="menu-item">Harita</a></li>
		</ul>
	</nav>
